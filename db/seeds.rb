...
sports = Sport.create!(
  [
    ...
    {name: 'Speed-Walking', icon_name: 'walking'},
    {name: 'Bird-Watching', icon_name: 'crow'},
    {name: 'Shopping', icon_name: 'cart-plus'},
    {name: 'Gambling', icon_name: 'dice'},
    {name: 'Frog-Jumping', icon_name: 'frog'},
    {name: 'Racing', icon_name: 'motorcycle'},
    {name: 'Spying', icon_name: 'user-secret'}
  ]
)
p 'Created Sports'
...
20.times do
  user_objects << {
    ...
    teams: teams.sample([1,2,3,4,5].sample),
    sports: sports.sample([1,2,3,4,5].sample)
  }
end
